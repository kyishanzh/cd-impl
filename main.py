...
def contrastive_generation(amateur, expert, prompt, max_tokens=None) -> str:
    """
    Perform contrastive generation using the provided amateur and expert models.
    :param amateur: Amateur model
    :param expert: Expert model
    :param prompt: Input prompt to start generation
    :param max_tokens: Maximum number of tokens to generate
    :return: Output generated by contrastive generation process (without prompt).
    """
    # tokenize prompt
    ...
    while True:
        ...
        # implementing CD: CD score = { log_exp - log_ama if token passed cutoff; else -inf
...
def vanilla_generation(model, prompt, max_tokens) -> str:
    """
    Vanilla generation with the provided model (Qwen 0.5B or 1.5B).
    :param model: Model to perform inference with
    :param prompt: Prompt
    :param max_tokens: Maximum number of tokens to generate
    :return: Output generated by vanilla generation process (without prompt).
    """
    encoded = tokenizer(prompt, return_tensors="pt", padding=True, truncation=True)
